...
_G.packer_plugins = {
  ...
  black = {
    loaded = true,
    path = "/home/michael/.local/share/nvim/site/pack/packer/start/black",
  ...
  ["vsc-rspec"] = {
    loaded = true,
    path = "/home/michael/.local/share/nvim/site/pack/packer/start/vsc-rspec",
    url = "https://github.com/SaimonL/vsc-rspec"
  },
  ["vscode-odoo-snippets"] = {
    loaded = true,
    path = "/home/michael/.local/share/nvim/site/pack/packer/start/vscode-odoo-snippets",
